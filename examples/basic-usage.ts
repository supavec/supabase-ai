...
// Initialize SupabaseAI with OpenAI provider
...
async function basicExample() {
  try {
    ...
    const results = await ai.embeddings.search('artificial intelligence machine learning', {
      table: 'documents',
      limit: 5,
      threshold: 0.7,
    ...
    console.log(`Similarity between "artificial intelligence" and "machine learning": ${similarity.toFixed(3)}`)
